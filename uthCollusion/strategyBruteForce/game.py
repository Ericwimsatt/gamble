...
if __name__ == "__main__":
    print("RUNNING GAMES_____")
    for i in range(5):
        print("___")
        print(play_game(lambda hand, dead_cards: True, lambda hand, board, dead_cards: True, lambda hand, board, dead_cards: True))
        print(play_game(lambda hand, dead_cards: False, lambda hand, board, dead_cards: True, lambda hand, board, dead_cards: True))
        print(play_game(lambda hand, dead_cards: False, lambda hand, board, dead_cards: False, lambda hand, board, dead_cards: True))
        print(play_game(lambda hand, dead_cards: False, lambda hand, board, dead_cards: False, lambda hand, board, dead_cards: False))
